...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--adapter-path', type=str, default='/data/huwenp/emb/lxy/sd-zero-sql/outputs/qwen3_4b_sft_lora_4k')
    parser.add_argument('--train-file', type=str, default='/home/pkuccadm/huwenp/emb/lxy/sd-zero-sql/data/srt/srt_train_mixed.jsonl')
    parser.add_argument('--valid-file', type=str, default='/home/pkuccadm/huwenp/emb/lxy/sd-zero-sql/data/ches_train_sft_valid_4k.jsonl')
    parser.add_argument('--output-dir', type=str, default='/data/huwenp/emb/lxy/sd-zero-sql/outputs/qwen3_4b_srt_lora_4k')
