...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='Train Phase1 SRT model for CHES SQL.')
    parser.add_argument('--model-path', type=str, default='/data/model/Qwen3-4B-Instruct-2507')
    parser.add_argument('--adapter-path', type=str, default='/data/huwenp/emb/lxy/ches_sql_sft/outputs/qwen3_4b_sft_lora_4k')
    parser.add_argument('--train-file', type=str, default='/home/pkuccadm/huwenp/emb/lxy/ches_sql_sft/data/srt/srt_train_mixed.jsonl')
    parser.add_argument('--valid-file', type=str, default='/home/pkuccadm/huwenp/emb/lxy/ches_sql_sft/data/ches_train_sft_valid_4k.jsonl')
    parser.add_argument('--output-dir', type=str, default='/data/huwenp/emb/lxy/ches_sql_sft/outputs/qwen3_4b_srt_lora_4k')
...
def load_jsonl_dataset(path: str, max_samples: int = None):
