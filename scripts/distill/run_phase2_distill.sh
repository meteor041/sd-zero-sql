...
OUTPUT_DIR="${OUTPUT_DIR:-/home/pkuccadm/huwenp/emb/lxy/ches_sql_sft/outputs/sql_distill_smoke}"
DEBUG_MANIFEST="${DEBUG_MANIFEST:-/home/pkuccadm/huwenp/emb/lxy/ches_sql_sft/data/distill/sql_distill_debug_manifest.jsonl}"
...
${PYTHON_BIN} /home/pkuccadm/huwenp/emb/lxy/ches_sql_sft/src/phase2_distill/train_distill_kl.py \
